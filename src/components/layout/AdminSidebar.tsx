...
const AdminSidebar: React.FC = () => {
  ...
  const reportPrefixes = [
    ...
    "/dashboard-admin/tutor-no-schedule",
          ...
          <li>
            ...
            <DropWrap open={openManage}>
              <div className="pl-6 relative">
                ...
                />
                <SubItem
                  to="/dashboard-admin/revision-templates"
                  label="Revision Templates"
                  active={isUnder("/dashboard-admin/revision-templates")}
                />
              </div>
            </DropWrap>
          </li>
          ...
          <li>
            ...
            <DropWrap open={openReport}>
              <div className="pl-6 relative">
                ...
                />
                <SubItem
                  to="/dashboard-admin/tutor-no-schedule"
                  label="Guru Tanpa Jadwal"
                  active={isUnder("/dashboard-admin/tutor-no-schedule")}
                />
                <SubItem
