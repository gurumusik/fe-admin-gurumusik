...
import TutorRevisionPage from "@/features/dashboard/pages/tutor-revision/page";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/dashboard-admin/tutor-revision", element: <TutorRevisionPage /> },
      { path: "/dashboard-admin/verified-tutor/revisions", element: <Navigate to="/dashboard-admin/tutor-revision" replace /> },
